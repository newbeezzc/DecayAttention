...
from layers.SelfAttention_Family import FullAttention, AttentionLayer, DelayAttention
...
class Model(nn.Module):
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec, enc_mask, dec_mask,
        ...
        enc_gamma = self.enc_decay(enc_delta.to(x_enc.device)).to(x_enc.device)
        ...
        dec_gamma = self.dec_decay(dec_delta.to(x_dec.device)).to(x_dec.device)
